...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded-md border bg-background px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}
    >
...
function getPayloadConfigFromPayload(
  config: ChartConfig,
  payload: RechartsPrimitive.TooltipPayloadEntry | undefined,
  key: string
) {
